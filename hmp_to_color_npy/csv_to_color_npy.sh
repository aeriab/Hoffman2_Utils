...
INPUT_FILE="/u/home/b/baeria/project-ngarud/Research/WideSimsCNN/processed_r_bromii/cropped_r_bromii_data.csv"
OUTPUT_FILE="peter_logic_cropped_r_bromii.npy"
