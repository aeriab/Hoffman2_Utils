...
def main():
    ...
    # Assuming 500 replicates with 2 files each based on original logic
    total_expected = 500 * 2
    with tqdm(total=total_expected, desc="Processing Replicates") as pbar:
        for i in range(1, 501):
            for j in [1, 2]:
                filename = f"rep_{i}.{j}_haplotypes.csv"
